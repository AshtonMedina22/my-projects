...
with tab1:
    ...
    with col1:
        ...
        remove_emojis = st.checkbox("Remove emojis")
    ...
    with col2:
        if user_text:
            ...
            processed_text = preprocess_text_interactive(user_text, remove_punctuation, case_option, remove_emojis)
    ...
    if analyze_button and user_text and st.session_state.classifier:
        ...
        with st.spinner("Analyzing both versions..."):
            original_cleaned = preprocess_text(user_text)
            ...
            word_analysis = analyze_sentiment_words(processed_text)
